...
echo ""
echo "Changes in progress for v$VERSION are available at [.changes/v$VERSION](https://github.com/yetialex/go-vcloud-director/tree/master/.changes/v$VERSION) until the release."
echo ""
